...
class TxnMallTest(CreditsTestFramework):
    ...
    def run_test(self):
        ...
        # First: use raw transaction API to send 12400 CRDS to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 CRDS coin each
        ...
        # Node0's total balance should be starting balance, plus 1000 CRDS for
