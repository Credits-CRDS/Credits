...
class RawTransactionsTest(CreditsTestFramework):
    ...
    def setup_network(self, split=False):
        ...
        #url = "http://creditsrpc:DP6DvqZtqXarpeNWyN3LZTFchCCyCUuHwNF7E8pX99x1@%s:%d" % ('127.0.0.1', 31500)
